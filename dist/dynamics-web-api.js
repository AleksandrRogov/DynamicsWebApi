/*! dynamics-web-api v1.7.8 (c) 2023 Aleksandr Rogov */
...
function DynamicsWebApi(config) {
    ...
    this.associateSingleValued = function (collection, key, singleValuedNavigationPropertyName, relatedCollection, relatedKey, impersonateUserId) {
        ...
        return _makeRequest("PUT", request, "associateSingleValued").then(function () {});
    };
    ...
    this.disassociateSingleValued = function (collection, key, singleValuedNavigationPropertyName, impersonateUserId) {
        ...
        return _makeRequest("DELETE", request, "disassociateSingleValued").then(function () {});
    };
    ...
    this.executeBatch = function (request) {
        ...
        _isBatch = false;
        const promise = _makeRequest("POST", request, "executeBatch").then(function (response) {
            return response.data;
        });
