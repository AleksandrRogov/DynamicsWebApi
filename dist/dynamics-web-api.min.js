...
${p.method} ${t.dataApi.url}${p.path} HTTP/1.1`),u?n.push("Accept: application/json"):n.push("Content-Type: application/json");for(let h in p.headers)h==="Authorization"||h==="Content-ID"||n.push(`${h}: ${p.headers[h]}`);let x=p.data;!u&&x&&n.push(`
