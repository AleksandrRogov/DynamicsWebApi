...
export interface WebApiErrorResponse extends RequestError {}

export type BatchRequestCollection = Record<string, InternalRequest[]>;
...
export interface InternalBatchRequest {
    body: any;
    headers: HeaderCollection;
}
...
export interface InternalRequest {
    ...
    /**Sets an additional URL path after collection (EntitySet name), key and contentId if those are set */
    addPath?: string;
    fetchXml?: string;
    isBatch?: boolean;
    data?: any;
