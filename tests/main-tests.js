...
describe("promises -", function () {
    ...
    describe("dynamicsWebApi.update -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .update(mocks.data.testEntityId, "tests", mocks.data.testEntity)
                    .then(function (object) {
        ...
        describe("return representation", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .update(mocks.data.testEntityId, "tests", mocks.data.testEntity, DWA.Prefer.ReturnRepresentation)
                    .then(function (object) {
    ...
    describe("dynamicsWebApi.updateSingleProperty -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateSingleProperty(mocks.data.testEntityId, "tests", mocks.data.updatedEntity)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
        ...
        describe("return representation", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateSingleProperty(mocks.data.testEntityId, "tests", mocks.data.updatedEntity, DWA.Prefer.ReturnRepresentation)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.updatedEntity);
                        done();
                    })
        ...
        describe("select", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateSingleProperty(mocks.data.testEntityId, "tests", mocks.data.updatedEntity, DWA.Prefer.ReturnRepresentation, ["name"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.updatedEntity);
                        done();
                    })
    ...
    describe("dynamicsWebApi.upsert -", function () {
        describe("basic & update an existing entity", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .upsert(mocks.data.testEntityId, "tests", mocks.data.testEntity)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
        ...
        describe("return representation & update an existing entity", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .upsert(mocks.data.testEntityId, "tests", mocks.data.testEntity, DWA.Prefer.ReturnRepresentation)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.updatedEntity);
                        done();
                    })
    ...
    describe("dynamicsWebApi.deleteRecord -", function () {
        describe("basic", function () {
            ...
            before(function () {
                var response = mocks.responses.basicEmptyResponseSuccess;
                scope = nock(mocks.webApiUrl).delete(mocks.responses.testEntityUrl).reply(response.status, response.responseText, response.responseHeaders);
            });
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .deleteRecord(mocks.data.testEntityId, "tests")
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
        ...
        describe("single property", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .deleteRecord(mocks.data.testEntityId, "tests", "fullname")
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
    ...
    describe("dynamicsWebApi.retrieve -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("basic - alternate key", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve("alternateKey='keyValue'", "tests")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("select", function () {
            ...
            it("[fullname] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["fullname"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("[fullname, subject] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["fullname", "subject"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("single value or navigation property", function () {
            ...
            it("[/reference] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["/reference"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("[/reference, fullname] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["/reference", "fullname"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("[/reference, fullname, subject] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["/reference", "fullname", "subject"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("reference", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["reference/$ref"])
                    .then(function (object) {
        ...
        describe("expand basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", null, "reference(something)")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("select & expand basic", function () {
            ...
            it("[fullname] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["fullname"], "reference(something)")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("[fullname,subject] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["fullname", "subject"], "reference(something)")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("select & expand navigation property", function () {
            ...
            it("[/reference] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["/reference"], "reference(something)")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("[/reference, fullname] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["/reference", "fullname"], "reference(something)")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("[/reference, fullname, subject] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieve(mocks.data.testEntityId, "tests", ["/reference", "fullname", "subject"], "reference(something)")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
    ...
    describe("dynamicsWebApi.executeFetchXml -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeFetchXml("tests", mocks.data.fetchXmls.fetchXml)
                    .then(function (object) {
        ...
        describe("paging", function () {
            ...
            it("returns a correct response", function (done) {
                ...
                dynamicsWebApiTest
                    .executeFetchXml("tests", mocks.data.fetchXmls.fetchXml, null, pagingInfo.nextPage, pagingInfo.cookie)
                    .then(function (object) {
        ...
        describe("with top attribute", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeFetchXml("tests", mocks.data.fetchXmls.fetchXmlTop)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.fetchXmls.fetchXmlResultPage1Cookie);
                        done();
                    })
        ...
        describe("with prefer", function () {
            ...
            it("returns a correct response", function (done) {
                var pagingInfo = mocks.data.fetchXmls.fetchXmlResultPage1Cookie.PagingInfo;
                dynamicsWebApiTest
                    .executeFetchXml("tests", mocks.data.fetchXmls.fetchXml, DWA.Prefer.Annotations.FormattedValue, pagingInfo.nextPage, pagingInfo.cookie)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.fetchXmls.fetchXmlResultPage2Cookie);
                        done();
                    })
    ...
    describe("dynamicsWebApi.executeFetchXmlAll -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .fetchAll("tests", mocks.data.fetchXmls.fetchXml)
                    .then(function (object) {
    ...
    describe("dynamicsWebApi.associate -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .associate("tests", mocks.data.testEntityId, "tests_records", "records", mocks.data.testEntityId2)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
        ...
        describe("basic - use entity names: true", function () {
            ...
            it("returns a correct response", function (done) {
                ...
                dynamicsWebApiE
                    .associate("test", mocks.data.testEntityId, "tests_records", "record", mocks.data.testEntityId2)
                    .then(function (object) {
        ...
        describe("impersonation", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .associate("tests", mocks.data.testEntityId, "tests_records", "records", mocks.data.testEntityId2, mocks.data.testEntityId3)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
    ...
    describe("dynamicsWebApi.disassociate -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .disassociate("tests", mocks.data.testEntityId, "tests_records", mocks.data.testEntityId2)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
        ...
        describe("impersonation", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .disassociate("tests", mocks.data.testEntityId, "tests_records", mocks.data.testEntityId2, mocks.data.testEntityId3)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
    ...
    describe("dynamicsWebApi.associateSingleValued -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .associateSingleValued("tests", mocks.data.testEntityId, "tests_records", "records", mocks.data.testEntityId2)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
        ...
        describe("impersonation", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .associateSingleValued("tests", mocks.data.testEntityId, "tests_records", "records", mocks.data.testEntityId2, mocks.data.testEntityId3)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
    ...
    describe("dynamicsWebApi.disassociateSingleValued -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .disassociateSingleValued("tests", mocks.data.testEntityId, "tests_records")
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
        ...
        describe("impersonation", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .disassociateSingleValued("tests", mocks.data.testEntityId, "tests_records", mocks.data.testEntityId3)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
    ...
    describe("dynamicsWebApi.executeFunction -", function () {
        describe("unbound", function () {
            ...
            it("(with parameters) returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeUnboundFunction("FUN", { param1: "value1", param2: 2 })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("unbound impersonation", function () {
            ...
            it("(no parameters) returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeUnboundFunction("FUN", null, mocks.data.testEntityId)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("(with parameters) returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeUnboundFunction("FUN", { param1: "value1", param2: 2 }, mocks.data.testEntityId)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("bound", function () {
            ...
            it("(no parameters) returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeBoundFunction(mocks.data.testEntityId, "tests", "FUN")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("(with parameters) returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeBoundFunction(mocks.data.testEntityId, "tests", "FUN", { param1: "value1", param2: 2 })
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
        ...
        describe("bound impersonation", function () {
            ...
            it("(no parameters) returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeBoundFunction(mocks.data.testEntityId, "tests", "FUN", null, mocks.data.testEntityId)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("(with parameters) returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeBoundFunction(mocks.data.testEntityId, "tests", "FUN", { param1: "value1", param2: 2 }, mocks.data.testEntityId)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
    ...
    describe("dynamicsWebApi.executeAction -", function () {
        describe("unbound", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeUnboundAction("FUN", mocks.responses.actionRequest)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
        ...
        describe("unbound impersonation", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeUnboundAction("FUN", mocks.responses.actionRequest, mocks.data.testEntityId2)
                    .then(function (object) {
                        done(object);
                    })
                    .catch(function (object) {
        ...
        describe("bound", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeBoundAction(mocks.data.testEntityId, "tests", "FUN", mocks.responses.actionRequest)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("bound impersonation", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .executeBoundAction(mocks.data.testEntityId, "tests", "FUN", mocks.responses.actionRequest, mocks.data.testEntityId2)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
    ...
    describe("dynamicsWebApi.retrieveMultiple -", function () {
        ...
        describe("goes by next page link", function () {
            ...
            before(function () {
                ...
                scope = nock(link).get(getLink).reply(response.status, response.responseText, response.responseHeaders);
            });
    ...
    describe("dynamicsWebApi.retrieveMultipleRequest -", function () {
        ...
        describe("when goes by next page link", function () {
            ...
            it("returns a correct response", function (done) {
                ...
                dynamicsWebApiTest
                    .retrieveMultipleRequest(dwaRequest, mocks.responses.multipleWithLink().oDataNextLink)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    })
        ...
        describe("when goes by delta link (@odata.deltaLink)", function () {
            ...
            it("returns a correct response", function (done) {
                ...
                dynamicsWebApiTest
                    .retrieveMultipleRequest(dwaRequest, mocks.responses.multipleWithDeltaLink().oDataDeltaLink)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    })
    ...
    describe("dynamicsWebApi.createEntity -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .createEntity(mocks.data.testEntity)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntityId);
                        done();
                    })
    ...
    describe("dynamicsWebApi.updateEntity -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateEntity(mocks.data.testEntityDefinition)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
        ...
        describe("mergeLabels = true", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateEntity(mocks.data.testEntityDefinition, true)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
    ...
    describe("dynamicsWebApi.retrieveEntity -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveEntity(mocks.data.testEntityId)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("basic - alternate key", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveEntity("alternateKey='keyValue'")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveEntity(mocks.data.testEntityId, ["LogicalName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveEntity(mocks.data.testEntityId, ["LogicalName", "SchemaName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
    ...
    describe("dynamicsWebApi.createAttribute -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .createAttribute(mocks.data.testEntityId, mocks.data.testEntity)
                    .then(function (object) {
    ...
    describe("dynamicsWebApi.updateAttribute -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateAttribute(mocks.data.testEntityId, mocks.data.testAttributeDefinition)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
        ...
        describe("mergeLabels = true", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateAttribute(mocks.data.testEntityId, mocks.data.testAttributeDefinition, null, true)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
        ...
        describe("with Attribute Type", function () {
            ...
            before(function () {
                ...
                scope = nock(mocks.webApiUrl, {
                    ...
                    .put(
                        mocks.responses.entityDefinitionsIdUrl + "/Attributes(" + mocks.data.testEntityId2 + ")/AttributeType",
                        mocks.data.testAttributeDefinition
                    )
                    .reply(response.status, response.responseText, response.responseHeaders);
            });
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateAttribute(mocks.data.testEntityId, mocks.data.testAttributeDefinition, "AttributeType")
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
        ...
        describe("with Attribute Type & mergeLabels = true", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateAttribute(mocks.data.testEntityId, mocks.data.testAttributeDefinition, "AttributeType", true)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
    ...
    describe("dynamicsWebApi.retrieveAttributes -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveAttributes(mocks.data.testEntityId)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    })
        ...
        describe("with AttributeType", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveAttributes(mocks.data.testEntityId, "AttributeType")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    })
    ...
    describe("dynamicsWebApi.retrieveAttribute -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveAttribute(mocks.data.testEntityId, mocks.data.testEntityId2)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("basic - AlternateKeys", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveAttribute("SchemaName='Test'", "LogicalName='Test2'")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("with AttributeType", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveAttribute(mocks.data.testEntityId, mocks.data.testEntityId2, "AttributeType")
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
    ...
    describe("dynamicsWebApi.createRelationship -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .createRelationship(mocks.data.testEntity)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntityId);
                        done();
                    })
    ...
    describe("dynamicsWebApi.updateRelationship -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateRelationship(mocks.data.testEntityDefinition)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
        ...
        describe("cast relationship", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateRelationship(mocks.data.testEntityDefinition, "testcast")
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
        ...
        describe("mergeLabels = true", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateRelationship(mocks.data.testEntityDefinition, null, true)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
    ...
    describe("dynamicsWebApi.deleteRelationship -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .deleteRelationship(mocks.data.testEntityId)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
    ...
    describe("dynamicsWebApi.retrieveRelationship -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveRelationship(mocks.data.testEntityId)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveRelationship(mocks.data.testEntityId, null, ["LogicalName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveRelationship(mocks.data.testEntityId, null, ["LogicalName", "SchemaName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("cast relationship, select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveRelationship(mocks.data.testEntityId, "testcast", ["LogicalName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveRelationship(mocks.data.testEntityId, "testcast", ["LogicalName", "SchemaName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
    ...
    describe("dynamicsWebApi.retrieveRelationships -", function () {
        ...
        describe("cast, select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveRelationships("testcast", ["LogicalName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    })
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveRelationships("testcast", ["LogicalName", "SchemaName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    })
    ...
    describe("dynamicsWebApi.createGlobalOptionSet -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .createGlobalOptionSet(mocks.data.testEntity)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntityId);
                        done();
                    })
    ...
    describe("dynamicsWebApi.updateGlobalOptionSet -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateGlobalOptionSet(mocks.data.testEntityDefinition)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
        ...
        describe("mergeLabels = true", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .updateGlobalOptionSet(mocks.data.testEntityDefinition, true)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
    ...
    describe("dynamicsWebApi.deleteGlobalOptionSet -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .deleteGlobalOptionSet(mocks.data.testEntityId)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    })
    ...
    describe("dynamicsWebApi.retrieveGlobalOptionSet -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveGlobalOptionSet(mocks.data.testEntityId)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
        ...
        describe("select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveGlobalOptionSet(mocks.data.testEntityId, null, ["LogicalName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveGlobalOptionSet(mocks.data.testEntityId, null, ["LogicalName", "SchemaName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    })
    ...
    describe("dynamicsWebApi.retrieveGlobalOptionSets -", function () {
        ...
        describe("cast, select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveGlobalOptionSets("casttype", ["LogicalName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    })
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
                dynamicsWebApiTest
                    .retrieveGlobalOptionSets("casttype", ["LogicalName", "SchemaName"])
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    })
    ...
    describe("dynamicsWebApi.constructor -", function () {
        describe("webApiVersion", function () {
            ...
            before(function () {
                var response = mocks.responses.createReturnId;
                scope = nock(mocks.webApiUrl80).post("/tests", mocks.data.testEntity).reply(response.status, response.responseText, response.responseHeaders);
            });
        ...
        describe("authorization - when token set in the request it overrides token returned from a callback", function () {
            ...
            it("sends the request to the right end point and returns a response", function (done) {
                var dynamicsWebApiAuth = new DynamicsWebApi({ onTokenRefresh: getToken, webApiUrl: mocks.webApiUrl });
                dynamicsWebApiAuth
                    .retrieveMultipleRequest({ collection: "tests", token: "overriden" })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    })
    ...
    describe("dynamicsWebApi.setConfig -", function () {
        ...
        describe("impersonate overriden with a request.impersonate", function () {
            ...
            it("sends the request to the right end point with a correct MSCRMCallerID header", function (done) {
                dynamicsWebApi81.setConfig({ webApiVersion: "8.1", impersonate: mocks.data.testEntityId2 });
                dynamicsWebApi81
                    .retrieveMultipleRequest({ collection: "tests", impersonate: mocks.data.testEntityId3 })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    })
        ...
        describe("impersonateAAD overriden with a request.impersonateAAD", function () {
            ...
            it("sends the request to the right end point with a correct CallerObjectId header", function (done) {
                dynamicsWebApi90.setConfig({ webApiVersion: "9.0", impersonateAAD: mocks.data.testEntityId2 });
                dynamicsWebApi90
                    .retrieveMultipleRequest({ collection: "tests", impersonateAAD: mocks.data.testEntityId3 })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    })
