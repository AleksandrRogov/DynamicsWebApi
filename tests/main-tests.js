...
describe("promises -", function () {
    describe("dynamicsWebApi.create -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.create({ data: mocks.data.testEntity, collection: "tests" })
    ...
    describe("dynamicsWebApi.update -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.update({ key: mocks.data.testEntityId, collection: "tests", data: mocks.data.testEntity })
                    .then(function (object) {
        ...
        describe("return representation", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.update({ key: mocks.data.testEntityId, collection: "tests", data: mocks.data.testEntity, returnRepresentation: true })
                    .then(function (object) {
        ...
        describe("return representation - select", function () {
            ...
            it("[fullname] returns a correct response", function (done) {
                dynamicsWebApiTest
					.update({ key: mocks.data.testEntityId, collection: "tests", data: mocks.data.testEntity, returnRepresentation: true, select: ["fullname"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.updatedEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[fullname, subject] returns a correct response", function (done) {
                dynamicsWebApiTest
					.update({ key: mocks.data.testEntityId, collection: "tests", data: mocks.data.testEntity, returnRepresentation: true, select: ["fullname", "subject"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.updatedEntity);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.upsert -", function () {
        ...
        describe("basic & update an existing entity", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.upsert({ key: mocks.data.testEntityId, collection: "tests", data: mocks.data.testEntity })
                    .then(function (object) {
                        done(object);
                    }).catch(function (object) {
                        done(object);
        ...
        describe("return representation & update an existing entity", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.upsert({ key: mocks.data.testEntityId, collection: "tests", data: mocks.data.testEntity, returnRepresentation: true })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.updatedEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("return representation & update an existing entity & select", function () {
            ...
            it("[fullname] returns a correct response", function (done) {
                dynamicsWebApiTest
					.upsert({ key: mocks.data.testEntityId, collection: "tests", data: mocks.data.testEntity, returnRepresentation: true, select: ["fullname"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.updatedEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[fullname, subject] returns a correct response", function (done) {
                dynamicsWebApiTest
					.upsert({ key: mocks.data.testEntityId, collection: "tests", data: mocks.data.testEntity, returnRepresentation: true, select: ["fullname", "subject"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.updatedEntity);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.retrieve -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests" })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("basic - alternate key", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: "alternateKey='keyValue'", collection: "tests" })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("select", function () {
            ...
            it("[fullname] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["fullname"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[fullname, subject] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["fullname", "subject"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("single value or navigation property", function () {
            ...
            it("[/reference] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["/reference"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[/reference, fullname] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["/reference", "fullname"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[/reference, fullname, subject] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["/reference", "fullname", "subject"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("reference", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["reference/$ref"] })
                    .then(function (object) {
        ...
        describe("expand basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", expand: [{ property: "reference", select: ["something"] }] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("select & expand basic", function () {
            ...
            it("[fullname] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["fullname"], expand: [{ property: "reference", select: ["something"] }] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[fullname,subject] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["fullname", "subject"], expand: [{ property: "reference", select: ["something"] }] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("select & expand navigation property", function () {
            ...
            it("[/reference] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["/reference"], expand: [{ property: "reference", select: ["something"]  }] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[/reference, fullname] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["/reference", "fullname"], expand: [{ property: "reference", select: ["something"]  }] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[/reference, fullname, subject] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieve({ key: mocks.data.testEntityId, collection: "tests", select: ["/reference", "fullname", "subject"], expand: [{ property: "reference", select: ["something"]  }] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.update -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                ...
                dynamicsWebApiTest.update(dwaRequest)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.upsert -", function () {
        ...
        describe("(update) basic", function () {
            ...
            it("(update) returns a correct response", function (done) {
                dynamicsWebApiTest.upsert(dwaRequest)
                    .then(function (object) {
                        done(object);
                    }).catch(function (object) {
                        done(object);
	...
	describe("dynamicsWebApi.retrieveMultiple -", function () {
        ...
        describe("when goes by delta link (@odata.deltaLink)", function () {
            ...
            it("returns a correct response", function (done) {
                ...
                dynamicsWebApiTest.retrieveMultiple(dwaRequest, mocks.responses.multipleWithDeltaLink().oDataDeltaLink)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.retrieveAll -", function () {
        ...
        describe("single page", function () {
            ...
            it("returns a correct response", function (done) {
                ...
                dynamicsWebApiTest.retrieveAll(dwaRequest)
                    .then(function (object) {
		...
		describe("multiple pages - delta link", function () {
			...
			it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveAll({ collection: "tests", select: ["name"] })
					.then(function (object) {
						var multipleResponse = mocks.responses.multiple();
						var checkResponse = { value: multipleResponse.value.concat(multipleResponse.value) };
    ...
    describe("dynamicsWebApi.deleteRecord -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
                ...
                dynamicsWebApiTest.deleteRecord(dwaRequest)
                    .then(function (object) {
                        expect(object).to.equal(true);
                        done();
                    }).catch(function (object) {
		...
		describe("single property", function () {
			...
			it("returns a correct response", function (done) {
				dynamicsWebApiTest.deleteRecord({ key: mocks.data.testEntityId, collection: "tests", navigationProperty: "fullname" })
					.then(function (object) {
                        expect(object).to.be.true;
						done();
					}).catch(function (object) {
    ...
    describe("dynamicsWebApi.createEntity -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.createEntity({ data: mocks.data.testEntity })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntityId);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.updateEntity -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateEntity({ data: mocks.data.testEntityDefinition })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
        ...
        describe("mergeLabels = true", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateEntity({ data: mocks.data.testEntityDefinition, mergeLabels: true })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.retrieveEntity -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveEntity({ key: mocks.data.testEntityId })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("basic - alternate key", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveEntity({ key: "alternateKey='keyValue'" })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveEntity({ key: mocks.data.testEntityId, select: ["LogicalName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveEntity({ key: mocks.data.testEntityId, select: ["LogicalName", "SchemaName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.createAttribute -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.createAttribute({ entityKey: mocks.data.testEntityId, data: mocks.data.testEntity })
                    .then(function (object) {
    ...
    describe("dynamicsWebApi.updateAttribute -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateAttribute({ entityKey: mocks.data.testEntityId, data: mocks.data.testAttributeDefinition })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
        ...
        describe("mergeLabels = true", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateAttribute({ entityKey: mocks.data.testEntityId, data: mocks.data.testAttributeDefinition, mergeLabels: true })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
        ...
        describe("with Attribute Type", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateAttribute({ entityKey: mocks.data.testEntityId, data: mocks.data.testAttributeDefinition, castType: 'AttributeType' })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
        ...
        describe("with Attribute Type & mergeLabels = true", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateAttribute({ entityKey: mocks.data.testEntityId, data: mocks.data.testAttributeDefinition, castType: 'AttributeType', mergeLabels: true })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.retrieveAttributes -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveAttributes({ entityKey: mocks.data.testEntityId })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    }).catch(function (object) {
        ...
        describe("with AttributeType", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveAttributes({ entityKey: mocks.data.testEntityId, castType: 'AttributeType' })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.retrieveAttribute -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveAttribute({ entityKey: mocks.data.testEntityId, attributeKey: mocks.data.testEntityId2 })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("basic - AlternateKeys", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveAttribute({ entityKey: "SchemaName='Test'", attributeKey: "LogicalName='Test2'" })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("with AttributeType", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveAttribute({ entityKey: mocks.data.testEntityId, attributeKey: mocks.data.testEntityId2, castType: 'AttributeType' })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.createRelationship -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.createRelationship({ data: mocks.data.testEntity })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntityId);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.updateRelationship -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateRelationship({ data: mocks.data.testEntityDefinition })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
        ...
        describe("cast relationship", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateRelationship({ data: mocks.data.testEntityDefinition, castType: "testcast" })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
        ...
        describe("mergeLabels = true", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateRelationship({ data: mocks.data.testEntityDefinition, mergeLabels: true })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.deleteRelationship -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.deleteRelationship({ key: mocks.data.testEntityId })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.retrieveRelationship -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveRelationship({ key: mocks.data.testEntityId })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveRelationship({ key: mocks.data.testEntityId, select: ["LogicalName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveRelationship({ key: mocks.data.testEntityId, select: ["LogicalName", "SchemaName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("cast relationship, select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveRelationship({ key: mocks.data.testEntityId, castType: "testcast", select: ["LogicalName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveRelationship({ key: mocks.data.testEntityId, castType: "testcast", select: ["LogicalName", "SchemaName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.retrieveRelationships -", function () {
        ...
        describe("cast, select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveRelationships({ castType: "testcast", select: ["LogicalName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    }).catch(function (object) {
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveRelationships({ castType: "testcast", select: ["LogicalName", "SchemaName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.createGlobalOptionSet -", function () {
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.createGlobalOptionSet({ data: mocks.data.testEntity })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntityId);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.updateGlobalOptionSet -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateGlobalOptionSet({ data: mocks.data.testEntityDefinition })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
        ...
        describe("mergeLabels = true", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.updateGlobalOptionSet({ data: mocks.data.testEntityDefinition, mergeLabels: true })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.deleteGlobalOptionSet -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.deleteGlobalOptionSet({ key: mocks.data.testEntityId })
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.retrieveGlobalOptionSet -", function () {
        ...
        describe("basic", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveGlobalOptionSet({ key: mocks.data.testEntityId })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveGlobalOptionSet({ key: mocks.data.testEntityId, select: ["LogicalName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveGlobalOptionSet({ key: mocks.data.testEntityId, select: ["LogicalName", "SchemaName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.retrieveGlobalOptionSets -", function () {
        ...
        describe("cast, select", function () {
            ...
            it("[LogicalName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveGlobalOptionSets({ castType: 'casttype', select: ["LogicalName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    }).catch(function (object) {
            ...
            it("[LogicalName, SchemaName] returns a correct response", function (done) {
				dynamicsWebApiTest.retrieveGlobalOptionSets({ castType: 'casttype', select: ["LogicalName", "SchemaName"] })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.entityDefinitionList);
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.constructor -", function () {
        ...
        describe("webApiVersion", function () {
            ...
            it("it makes a correct request and returns a correct response", function (done) {
				dynamicsWebApi91.create({ data: mocks.data.testEntity, collection: "tests" })
                    .then(function (object) {
        ...
        describe("authorization", function () {
            ...
            it("sends the request to the right end point and returns a response", function (done) {
                ...
                dynamicsWebApiAuth.retrieveMultiple({ collection: "tests" })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    }).catch(function (object) {
        ...
        describe("authorization - when token set in the request it overrides token returned from a callback", function () {
            ...
            it("sends the request to the right end point and returns a response", function (done) {
                var dynamicsWebApiAuth = new DynamicsWebApi({ onTokenRefresh: getToken, webApiUrl: mocks.webApiUrl });
                dynamicsWebApiAuth.retrieveMultiple({ collection: "tests", token: "overriden" })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    }).catch(function (object) {
        ...
        describe("prefer - include annotations added to request if set in the config", function () {
            ...
            it("it makes a correct request and returns a correct response", function (done) {
				dynamicsWebApi82.retrieve({ key: mocks.data.testEntityId, collection: "tests" })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.data.testEntity);
                        done();
                    }).catch(function (object) {
        ...
        describe("prefer - include annotations overriden if set in the request", function () {
            ...
            it("it makes a correct request and returns a correct response", function (done) {
                ...
                dynamicsWebApi82.retrieveMultiple(dwaRequest)
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    }).catch(function (object) {
        ...
        describe("prefer - return representation overriden if set in the request", function () {
            ...
            it("returns a correct response", function (done) {
                ...
                dynamicsWebApi82.update(dwaRequest)
                    .then(function (object) {
                        expect(object).to.be.true;
                        done();
                    }).catch(function (object) {
        ...
        describe("prefer - maxPageSize added to request if set in the config", function () {
            ...
            it("returns a correct response", function (done) {
				dynamicsWebApi82.retrieveMultiple({ collection: 'tests' })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.setConfig -", function () {
        ...
        describe("webApiVersion and impersonate", function () {
            ...
            it("it makes a correct request and returns a correct response", function (done) {
				dynamicsWebApi81.create({ data: mocks.data.testEntity, collection: "tests" })
                    .then(function (object) {
                        expect(object).to.equal(mocks.data.testEntityId);
                        done();
                    }).catch(function (object) {
        ...
        describe("webApiVersion is overriden by url set in setConfig", function () {
            ...
            it("sends the request to the right end point and returns a response", function (done) {
                ...
                dynamicsWebApi81.retrieveMultiple({ collection: "tests" })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    }).catch(function (object) {
    ...
    describe("dynamicsWebApi.initializeInstance -", function () {
        ...
        describe("current instance copied with its config", function () {
            ...
            it("sends the request to the right end point", function (done) {
				...
				dynamicsWebApiCopy.create({ data: mocks.data.testEntity, collection: "tests" })
                    .then(function (object) {
                        expect(object).to.equal(mocks.data.testEntityId);
                        done();
                    }).catch(function (object) {
        ...
        describe("config changed", function () {
            ...
            it("sends the request to the right end point", function (done) {
                ...
                dynamicsWebApiCopy.retrieveMultiple({ collection: "tests" })
                    .then(function (object) {
                        expect(object).to.deep.equal(mocks.responses.multiple());
                        done();
                    }).catch(function (object) {
