...
describe("promises -", function () {
	...
	describe("dynamicsWebApi.executeFunction -", function () {
		describe("unbound", function () {
			...
			it("(no parameters) returns a correct response", function (done) {
				dynamicsWebApiTest
					.executeUnboundFunction({ functionName: "FUN" })
					.then(function (object) {
						expect(object).to.deep.equal(mocks.data.testEntity);
						done();
					})
			...
			it("(with parameters) returns a correct response", function (done) {
				dynamicsWebApiTest
					.executeUnboundFunction({ functionName: "FUN", parameters: { param1: "value1", param2: 2 } })
					.then(function (object) {
						expect(object).to.deep.equal(mocks.data.testEntity);
						done();
					})
		...
		describe("unbound impersonation", function () {
			...
			it("(no parameters) returns a correct response", function (done) {
				dynamicsWebApiTest
					.executeUnboundFunction({ functionName: "FUN", impersonate: mocks.data.testEntityId })
					.then(function (object) {
						expect(object).to.deep.equal(mocks.data.testEntity);
						done();
					})
			...
			it("(with parameters) returns a correct response", function (done) {
				dynamicsWebApiTest
					.executeUnboundFunction({ functionName: "FUN", parameters: { param1: "value1", param2: 2 }, impersonate: mocks.data.testEntityId })
					.then(function (object) {
						expect(object).to.deep.equal(mocks.data.testEntity);
						done();
					})
		...
		describe("bound", function () {
			...
			it("(no parameters) returns a correct response", function (done) {
				dynamicsWebApiTest
					.executeBoundFunction({ id: mocks.data.testEntityId, collection: "tests", functionName: "FUN" })
					.then(function (object) {
						expect(object).to.deep.equal(mocks.data.testEntity);
						done();
					})
		...
		describe("bound impersonation", function () {
			...
			it("(no parameters) returns a correct response", function (done) {
				dynamicsWebApiTest
					.executeBoundFunction({ id: mocks.data.testEntityId, collection: "tests", functionName: "FUN", impersonate: mocks.data.testEntityId })
					.then(function (object) {
						expect(object).to.deep.equal(mocks.data.testEntity);
						done();
					})
	...
	describe("dynamicsWebApi.executeAction -", function () {
		describe("unbound", function () {
			...
			it("returns a correct response", function (done) {
				dynamicsWebApiTest
					.executeUnboundAction({ actionName: "FUN", action: mocks.responses.actionRequest })
					.then(function (object) {
						done(object);
					})
					.catch(function (object) {
		...
		describe("unbound impersonation", function () {
			...
			it("returns a correct response", function (done) {
				dynamicsWebApiTest
					.executeUnboundAction({ actionName: "FUN", action: mocks.responses.actionRequest, impersonate: mocks.data.testEntityId2 })
					.then(function (object) {
						done(object);
					})
					.catch(function (object) {
		...
		describe("bound", function () {
			...
			it("returns a correct response", function (done) {
				dynamicsWebApiTest
					.executeBoundAction({ id: mocks.data.testEntityId, collection: "tests", actionName: "FUN", action: mocks.responses.actionRequest })
					.then(function (object) {
						expect(object).to.deep.equal(mocks.data.testEntity);
						done();
					})
