...
var DynamicsWebApi = require(__dirname + "/lib/dynamics-web-api.js");
...
var dynamicsWebApiTest = DynamicsWebApi({ webApiUrl: webApiUrl });
...
module.exports = {
    Xrm: Xrm,
    dataStubs: dataStubs,
    responseStubs: responseStubs,
    webApiUrl: webApiUrl,
    webApiUrl81: webApiUrl81,
    webApiUrl80: webApiUrl80,
    dynamicsWebApiTest: dynamicsWebApiTest
}