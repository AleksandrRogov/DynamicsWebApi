...
var CrmWebApi = function () {
    ...
    var createRecord = function (object, type, returnData) {
        ...
        if (returnData != null) {
            _boolParameterCheck(returnData, "CrmWebApi.createRecord requires the returnData parameter a boolean.");
    ...
    var updateRecord = function (id, type, object, returnData, select) {
        ...
        if (returnData != null) {
            _boolParameterCheck(returnData, "CrmWebApi.updateRecord requires the returnData parameter a boolean.");
            additionalConfig = { headers: { "Prefer": "return=representation" } };
        }
        ...
        if (select != null) {
            _arrayParameterCheck(select, "CrmWebApi.updateRecord requires the select parameter an array.");
    ...
    var upsertRecord = function (id, type, object, ifmatch, ifnonematch) {
        ...
        if (ifmatch != null) {
            _stringParameterCheck(ifmatch, "CrmWebApi.upsertRecord requires the ifmatch parameter is a string.");

            additionalConfig = { headers: { 'If-Match': ifmatch } };
        }

        if (ifnonematch != null) {
            _stringParameterCheck(ifmatch, "CrmWebApi.upsertRecord requires the ifnonematch parameter is a string.");
