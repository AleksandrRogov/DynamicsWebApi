...
const getApiUrl = (orgUrl, apiConfig) => {
    if (!orgUrl)
        orgUrl = Utility_1.Utility.getClientUrl();
...
class ConfigurationUtility {
    static merge(internalConfig, config) {
        if (config === null || config === void 0 ? void 0 : config.organizationUrl) {
            ErrorHelper_1.ErrorHelper.stringParameterCheck(config.organizationUrl, "DynamicsWebApi.setConfig", "config.organizationUrl");
