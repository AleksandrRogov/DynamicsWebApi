...
class DynamicsWebApi {
    constructor(config) {
        ...
        this.createEntity = (request) => {
            ...
            return this.createRequest(internalRequest);
        };
        /**
        ...
        this.updateEntity = (request) => {
            ...
            internalRequest.method = "PUT";
            return this.updateRequest(internalRequest);
        };
        /**
        ...
        * @returns {Promise} D365 Web Api result
        ...
        this.retrieveEntity = (request) => {
            ...
            return this.retrieveRequest(internalRequest);
        };
        /**
        ...
        this.retrieveEntities = (request) => {
            ...
            return this.retrieveMultipleRequest(internalRequest);
        };
        /**
        ...
        this.deleteRelationship = (request) => {
            ...
            return this.deleteRequest(internalRequest);
        };
        /**
