    ...
    constructor(config) {
        ...
        this.setConfig = (config) => {
            ...
            if (config.impersonateAAD) {
                this._internalConfig.impersonateAAD = ErrorHelper_1.ErrorHelper.guidParameterCheck(config.impersonateAAD, "DynamicsWebApi.setConfig", "config.impersonateAAD");
            }
        ...
        this._uploadFileChunk = (request, fileBytes, chunkSize, offset) => {
            offset = offset || 0;
        ...
        this.uploadFile = (request) => {
            ErrorHelper_1.ErrorHelper.batchIncompatible("DynamicsWebApi.uploadFile", this._isBatch);
        ...
        this._downloadFileChunk = (request, bytesDownloaded, fileSize, data) => {
        ...
        this.downloadFile = (request) => {
            ErrorHelper_1.ErrorHelper.batchIncompatible("DynamicsWebApi.downloadFile", this._isBatch);
        ...
        this.retrieveEntities = (request) => {
            let internalRequest = !request ? {} : Utility_1.Utility.copyObject(request);
            internalRequest.collection = "EntityDefinitions";
