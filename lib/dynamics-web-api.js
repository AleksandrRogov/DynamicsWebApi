...
class DynamicsWebApi {
    constructor(config) {
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.countAll = (collection, filter, select) => {
        ...
        //	});
        //};
        this.executeFetchXml = (collection, fetchXml, includeAnnotations, pageNumber, pagingCookie, impersonateUserId) => {
            ErrorHelper_1.ErrorHelper.stringParameterCheck(fetchXml, "DynamicsWebApi.executeFetchXml", "fetchXml");
            pageNumber = pageNumber || 1;
            ErrorHelper_1.ErrorHelper.numberParameterCheck(pageNumber, "DynamicsWebApi.executeFetchXml", "pageNumber");
            var replacementString = '$1 page="' + pageNumber + '"';
            if (pagingCookie != null) {
                ErrorHelper_1.ErrorHelper.stringParameterCheck(pagingCookie, "DynamicsWebApi.executeFetchXml", "pagingCookie");
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.fetch = this.executeFetchXml;
        /**
         * Sends an asynchronous request to execute FetchXml to retrieve records. Returns: DWA.Types.FetchXmlResponse
         *
         * @param {string} collection - The name of the Entity Collection or Entity Logical name.
        ...
        this._executeFetchXmlAll = (collection, fetchXml, includeAnnotations, pageNumber, pagingCookie, impersonateUserId, records) => {
            records = records || [];
        ...
        this.innerExecuteFetchXmlAll = (collection, fetchXml, includeAnnotations, impersonateUserId) => {
            ErrorHelper_1.ErrorHelper.batchIncompatible('DynamicsWebApi.executeFetchXmlAll', this._isBatch);
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.fetchAll = this.innerExecuteFetchXmlAll;
        /**
         * Sends an asynchronous request to execute FetchXml to retrieve all records.
         *
         * @param {string} collection - The name of the Entity Collection or Entity Logical name.
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.executeFetchXmlAll = this.innerExecuteFetchXmlAll;
        /**
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.associate = (collection, primaryKey, relationshipName, relatedCollection, relatedKey, impersonateUserId) => {
            ErrorHelper_1.ErrorHelper.stringParameterCheck(relatedCollection, "DynamicsWebApi.associate", "relatedcollection");
            ErrorHelper_1.ErrorHelper.stringParameterCheck(relationshipName, "DynamicsWebApi.associate", "relationshipName");
            primaryKey = ErrorHelper_1.ErrorHelper.keyParameterCheck(primaryKey, "DynamicsWebApi.associate", "primaryKey");
            relatedKey = ErrorHelper_1.ErrorHelper.keyParameterCheck(relatedKey, "DynamicsWebApi.associate", "relatedKey");
            var request = {
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.disassociate = (collection, primaryKey, relationshipName, relatedKey, impersonateUserId) => {
            ErrorHelper_1.ErrorHelper.stringParameterCheck(relationshipName, "DynamicsWebApi.disassociate", "relationshipName");
            relatedKey = ErrorHelper_1.ErrorHelper.keyParameterCheck(relatedKey, "DynamicsWebApi.disassociate", "relatedId");
            var request = {
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.associateSingleValued = (collection, key, singleValuedNavigationPropertyName, relatedCollection, relatedKey, impersonateUserId) => {
            relatedKey = ErrorHelper_1.ErrorHelper.keyParameterCheck(relatedKey, "DynamicsWebApi.associateSingleValued", "relatedKey");
            ErrorHelper_1.ErrorHelper.stringParameterCheck(singleValuedNavigationPropertyName, "DynamicsWebApi.associateSingleValued", "singleValuedNavigationPropertyName");
            ErrorHelper_1.ErrorHelper.stringParameterCheck(relatedCollection, "DynamicsWebApi.associateSingleValued", "relatedcollection");
            var request = {
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.disassociateSingleValued = (collection, key, singleValuedNavigationPropertyName, impersonateUserId) => {
            ErrorHelper_1.ErrorHelper.stringParameterCheck(singleValuedNavigationPropertyName, "DynamicsWebApi.disassociateSingleValued", "singleValuedNavigationPropertyName");
            var request = {
                _additionalUrl: singleValuedNavigationPropertyName + "/$ref",
                key: key,
                collection: collection,
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.executeUnboundFunction = (functionName, parameters, impersonateUserId) => {
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.executeBoundFunction = (id, collection, functionName, parameters, impersonateUserId) => {
            return this._executeFunction(functionName, parameters, collection, id, impersonateUserId);
        };
        this._executeFunction = (functionName, parameters, collection, id, impersonateUserId, isUnbound = false) => {
            ErrorHelper_1.ErrorHelper.stringParameterCheck(functionName, "DynamicsWebApi.executeFunction", "functionName");
            var request = {
                _additionalUrl: functionName + Utility_1.Utility.buildFunctionParameters(parameters),
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.executeUnboundAction = (actionName, requestObject, impersonateUserId) => {
         ...
         */
        this.executeBoundAction = (id, collection, actionName, requestObject, impersonateUserId) => {
            return this._executeAction(actionName, requestObject, collection, id, impersonateUserId);
        };
        this._executeAction = (actionName, requestObject, collection, id, impersonateUserId, isUnbound = false) => {
            ErrorHelper_1.ErrorHelper.stringParameterCheck(actionName, "DynamicsWebApi.executeAction", "actionName");
            var request = {
