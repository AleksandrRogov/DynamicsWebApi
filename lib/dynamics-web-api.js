...
class DynamicsWebApi {
    constructor(config) {
        ...
        //	});
        //};
        this.fetch = (collection, fetchXml, includeAnnotations, pageNumber, pagingCookie, impersonateUserId) => {
         ...
         * @returns {Promise} D365 Web Api result
         */
        this.fetchAll = (collection, fetchXml, includeAnnotations, impersonateUserId) => {
            let _executeFetchXmlAll = (collection, fetchXml, includeAnnotations, pageNumber, pagingCookie, impersonateUserId, records) => {
                records = records || [];
