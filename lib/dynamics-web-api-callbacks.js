...
var { RequestClient } = require('./requests/RequestClient');
...
function DynamicsWebApi(config) {
    ...
    var _makeRequest = function (method, request, functionName, successCallback, errorCallback, responseParams) {
        ...
        RequestClient.makeRequest(method, request, functionName, _internalConfig, responseParams, successCallback, errorCallback);
    };
